...
public class GameHallFrame extends JFrame {
	...
	//大厅聊天的服务器处理类
	private final static String CHAT_SERVER_ACTION = "com.lansmancai.lanhall.fivechess.server.action.SendMessageAction";
	
	//大厅聊天的客户端处理类
	private final static String CHAT_CLIENT_ACTION = "com.lansmancai.lanhall..fivechess.client.action.ReceiveMessageAction";
	...
	public void sendUserIn() {
		...
		Request req = new Request("com.lansmancai.lanhall.fivechess.server.action.NewUserInAction", 
				"com.lansmancai.lanhall.fivechess.client.action.ReceiveInAction");
