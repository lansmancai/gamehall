...
public class ChessFrame extends JFrame {
	...
	//聊天服务器处理类
	private final static String CHAT_SERVER_ACTION = "com.lansmancai.lanhall.fivechess.server.action.GameMessageAction";
	
	//聊天内容接收类
	private final static String CHAT_CLIENT_ACTION = "com.lansmancai.lanhall.fivechess.client.action.game.ReceiveMessageAction";
	...
	public void leave() {
		...
		Request request = new Request("com.lansmancai.lanhall.fivechess.server.action.LeaveGameAction", 
				"com.lansmancai.lanhall.fivechess.client.action.game.LeaveGameAction");
		request.setParameter("userId", userId);
		request.setParameter("tableNumber", tableNumber);
		//设置对手接收到退出后的处理类
		request.setParameter("exitAction", 
				"com.lansmancai.lanhall.fivechess.client.action.game.OpponentExitAction");
		destroyUI();
		//设置玩家准备状态
