package com.lansmancai.lanhall.fivechess.client.ui.game;
...
import com.lansmancai.lanhall.fivechess.client.util.ImageUtil;
import com.lansmancai.lanhall.fivechess.commons.Chess;
import com.lansmancai.lanhall.fivechess.commons.ChessUser;
import com.lansmancai.lanhall.fivechess.commons.Seat;
...
public class GamePanel extends JPanel {
	...
	private void requestTakeChess(Chess chess) {
		Request request = new Request(
			"com.lansmancai.lanhall.fivechess.server.action.TakeChessAction", 
			"com.lansmancai.lanhall.fivechess.client.action.game.TakeChessAction");
		...
		request.setParameter("winAction", 
				"com.lansmancai.lanhall.fivechess.client.action.game.WinAction");
		//设置处理输的Action
		request.setParameter("lostAction", 
				"com.lansmancai.lanhall.fivechess.client.action.game.LostAction");
	...
	private void ready() {
		...
		Request request = new Request("com.lansmancai.lanhall.fivechess.server.action.ReadyAction", 
				"com.lansmancai.lanhall.fivechess.client.action.game.StartGameAction");
		request.setParameter("userId", this.user.getId());
		request.setParameter("tableNumber", this.table.getTableNumber());
		//如果对手没有准备, 则设置对手的处理类
		request.setParameter("opponentAction", 
				"com.lansmancai.lanhall.fivechess.client.action.game.OpponentReadyAction");
		Usocket.ps.println(XStreamUtil.toXML(request));
	}
	...
	private void requestDraw() {
		...
		if (result == 0) {
			Request request = new Request(
					"com.lansmancai.lanhall.fivechess.server.action.DrawAction", 
			"com.lansmancai.lanhall.fivechess.client.action.game.DrawAction");
			request.setParameter("userId", this.user.getId());
			request.setParameter("tableNumber", this.table.getTableNumber());
			Usocket.ps.println(XStreamUtil.toXML(request));
		} else {
	...
	public void sendLostRequest() {
		Request request = new Request(
		"com.lansmancai.lanhall.fivechess.server.action.LostAction", 
		"com.lansmancai.lanhall.fivechess.client.action.game.OpponentLostAction");
		request.setParameter("userId", this.user.getId());
		request.setParameter("tableNumber", this.table.getTableNumber());
		Usocket.ps.println(XStreamUtil.toXML(request));
	}
	...
	private void refuseDraw() {
		//告诉服务器拒绝和棋
		Request request = new Request("com.lansmancai.lanhall.fivechess.server.action.RefuseDrawAction", 
				"com.lansmancai.lanhall.fivechess.client.action.game.RefuseDrawAction");
		request.setParameter("userId", this.user.getId());
		request.setParameter("tableNumber", this.table.getTableNumber());
		Usocket.ps.println(XStreamUtil.toXML(request));
	}
	...
	private void agreeDraw() {
		draw();
		//告诉服务器同意求和
		Request request = new Request("com.lansmancai.lanhall.fivechess.server.action.AgreeDrawAction", 
				"com.lansmancai.lanhall.fivechess.client.action.game.AgreeDrawAction");
		request.setParameter("userId", this.user.getId());
		request.setParameter("tableNumber", this.table.getTableNumber());
		Usocket.ps.println(XStreamUtil.toXML(request));
	}
