...
public class HallPanel extends JPanel {
	...
	private void sendServerSitDown(Table table, String side) {
		//创建Request对象并设置相关的参数
		Request request = new Request("com.lansmancai.lanhall.fivechess.server.action.UserSitDownAction", 
				"com.lansmancai.lanhall.fivechess.client.action.ReceiveUserSitDownAction");
		...
		request.setParameter("beginClass", 
				"com.lansmancai.lanhall.fivechess.client.action.game.EnterGameAction");
